...
{% hint style="info" %}
[Click here](enterprise-cloud-credentials) to see how to configure FiftyOne
{% endhint %}
...
[Enterprise SDK](enterprise-python-sdk), media files will automatically be
...
[annotate data with CVAT](cvat-integration),
...
When using FiftyOne to
[annotate data with Labelbox](labelbox-integration), you can optionally
